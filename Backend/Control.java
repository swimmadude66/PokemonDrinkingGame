...
public class Control {
	...
	public void addPlayer(String n, int s) {
		...
		icon = colorImage(icon, colors[p.id % 7]);
		p.icon = icon;
		players.add(p);
		active = p;
		activeIndex = 0;
	...
	private void setUpTiles() {
		for (int i = 0; i < 160; i++) {
			...
			case 29:
				...
				break;
			case 30:
				newGuy = new VermillionGymTile(this, i);
				newGuy.isStop = true;
				newGuy.rollAgain = true;
			...
			case 41:
				...
				break;
			case 42:
				newGuy = new GameCornerTile(this, i);
			...
			case 57:
				...
				break;
			case 58:
				newGuy.text = "Primeape used Fury Swipes! If someone is wearing a hat, steal it from them before the end of the game.";
				break;
			case 59:
			...
			case 80:
				...
				break;
			case 81:
				newGuy = new ShellderTile(this, i);
			...
			case 85:
				...
				break;
			case 86:
				newGuy = new PlayerChooseTile(this, i, 1);
			...
			case 89:
				...
				break;
			case 90:
				newGuy = new PlayerChooseTile(this, i, 2);
			...
			case 93:
				...
				break;
			case 94:
				newGuy = new PlayerChooseTile(this, i, 0);
				newGuy.rollAgain = true;
			...
			case 98:
				...
				break;
			case 99:
				newGuy.text = "Tentacool used Constrict! Take 2 drinks.  Next turn, if you roll a 1 or 6 take a drink and try again the turn after.";
				newGuy.tentacool = true;
				break;
			case 100:
				newGuy = new TentacruelTile(this, i);
			...
			case 108:
				...
				break;
			case 109:
				newGuy = new CinnabarGymTile(this, i);
				newGuy.isStop = true;
				newGuy.rollAgain = true;
				newGuy.text = "Cinnabar Gym: Roll die. Even roll again. Odd, drink twice as many evens rolled.";
				break;
			case 110:
				newGuy.text = "Electrode used Explosion! Everyone takes 3 drinks.";
				break;
			case 111:
				newGuy.text = "Electabuzz used Thunder Punch! Any player on a space weak to electricity drinks 4.";
				break;
			case 112:
			...
			case 123:
				newGuy.isStop = true;
				newGuy.text = "Viridian Gym:First drink 1, then your gender drinks 3.";
				break;
			case 124:
			...
			case 146:
				...
				break;
			case 147:
				newGuy = new PokedexTile(this, i);
				newGuy.text = "So me and Oak just had a talk... You need to finish your Pokedex... Sorry 'bout that. First here \"remakes\" this square to any (s)he has landed on =excluding mandatories).";
				break;
			case 148:
				newGuy = new ExeggutorTile(this, i);
			...
			case 153:
				...
				break;
			case 154:
				newGuy.text = "Machamp used Submission! You pick 2 people from the group.  Clear some space because you're going to arm wrestle both of them with 1 hand, while they both use 2.  Loser(s) drink(s) 5.  Good luck.";
				break;
			case 155:
				newGuy = new TrickTile(this, i);
				newGuy.rollAgain = true;
				newGuy.moveAgain = true;
	...
	public int roll() {
		frame.player.setText(active.toString());
		int roll = die.rollDie();
		frame.rollResult.setText("" + roll);
		active.rollAgain = false;
		if (active.moving) {
			move(roll);
		}
		if (!active.moving && !active.rollAgain) {
			nextTurn();
		}
		return roll;
	}
	...
	public int move(int spaces) {
		...
		if (active.onTentacool) {
			if (spaces == 1 || spaces == 6) {
				return active.loc;
			}
		}
		int start = active.loc;
		spaces = (int) (spaces * active.mult);
		int sign;
		if(spaces == 0){
			System.out.println(active.loc);
			sign = 0;
		}
		else{
			sign = spaces / Math.abs(spaces);
		}
		for (int i = 1; i <= Math.abs(spaces); i++) {
			if (tiles.get(start + i).isStop) {
				active.loc = start + (i * sign);
				break;
			} else {
				active.loc += sign;
			}
	...
	public void land() {
		Tile spot = tiles.get(active.loc);
		active.history.add(spot);
		frame.punishment.setText("<html>" + spot.text + "</html>");
		spot.landed(active);
